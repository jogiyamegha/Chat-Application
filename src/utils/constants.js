...
const TableFields = (function () {
    ...
    TableFields.clearChatForMe = 'clearChatForMe'
    TableFields.clearChatForMeAt = 'clearChatForMeAt';
    TableFields.leftAt = 'leftAt';
    TableFields.removedParticipants = 'removedParticipants';
    TableFields.clearChat = 'clearChat';
    TableFields.clearChatAt = 'clearChatAt';
